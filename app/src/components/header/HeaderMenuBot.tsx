    ...
    return (
        <div>
            ...
            >
                ...
                <MenuItem component="a" href={botTest} onClick={handleClose}>Test</MenuItem>
                <MenuItem component="a" href={botStats} onClick={handleClose}>Stats</MenuItem>
            </Menu>
        </div>
    );
};
